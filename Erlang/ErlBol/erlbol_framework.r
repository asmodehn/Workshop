REBOL [Title: "Erlbol Framework"
Author: "Doug Edmunds"
Version: "2008.05.25.01"
Requires: "erlbol_framework.erl as server"]
...
;----Don't modify erlbol-parse unless you understand REBOL parsing

;----Don't change these values. They are for the binary input ---
...
if error? try [  
  ...
  view layout [
        h2   "Erlbol Framework v 2008.05.25.01" 
        h3   "http://erlbol.douglasedmunds.com"
        h3   "add_ints, add_numbers"
  ...
  [view layout [ h3 "Error making connection"
       ...
       text "Start Erlang server first"
       ]
  ]    
